 ...
 */
public class ActivityMyCoursrList extends ActivityBasic {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coach_mycourse);
        initial();
    }
...
//		super.onSaveInstanceState(outState);
    ...
    private void initial() {
        ...
        ((TextView) this.findViewById(R.id.middle_tv)).setText("我的课程");
...
//		tabs.setDividerColor(Color.TRANSPARENT);
    ...
    public class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        private final String[] TITLES = {"待上课", "已结束"};
        ...
        public Fragment getItem(int position) {
            return FragmentCoursList.newInstance(position);
        }
