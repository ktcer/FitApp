package com.cn.fit.customer.expandtab.view;
...
import com.cn.fit.R;
import com.cn.fit.customer.expandtab.adapter.TextAdapter;
...
public class ViewRight extends RelativeLayout implements ViewBaseAction {
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.cocach_view_distance, this, true);
