package com.cn.fit.customer.baidumapgeocoder;
 ...
 */
public class GeoCoderDemo extends ActivityBasic implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coach_geocoder);
        TextView titleText = (TextView) findViewById(R.id.middle_tv);
        titleText.setText("活动地点");
//		CharSequence titleLable = "地理编码功能";
//		setTitle(titleLable);
//		location = getIntent().getStringExtra("location");
        longitude = getIntent().getFloatExtra("longitude", (float) 116.355626);
        latitude = getIntent().getFloatExtra("latitude", (float) 39.959833);
        Log.i("hahaha", ">>>>>>longitude:" + longitude + ">>>>>latitude:" + latitude);
        // 地图初始化
