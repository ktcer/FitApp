...
public class PopSecretary {
    private List<BeanRegion> itemList;
    private Context context;
    private PopupWindow mPopupWindow;
    private ListView mListView;
    private LinearLayout transLayout;

    public PopSecretary(Context context, List<BeanRegion> itemList) {
        this.context = context;
        this.itemList = itemList;
        itemList = new ArrayList<BeanRegion>();
    ...
    public void addItem(BeanRegion item) {
        itemList.add(item);
    }
    ...
    private class popAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.menuItem.setText(itemList.get(position).getRegionName());
            return convertView;
        }
