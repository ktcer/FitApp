...
//		} else if (orientation == Configuration.ORIENTATION_PORTRAIT) {//竖屏幕
...
//	 * @param direction
//	 */
//	public void addMenuList(ListView menuList, int direction) {
//		if (direction == DIRECTION_LEFT) {
////			this.leftMenuItems.add(menuList);
//			layoutLeftMenu.addView(menuList);
//		} else {
////			this.rightMenuItems.add(menuItem);
//			layoutRightMenu.addView(menuList);
//		}
//	}
//
//	/**
...
//			pivotX = screenWidth * 3.5f;
//		} else {
//			scrollViewMenu = rightMenu;
//			pivotX = screenWidth * -2.5f;
//		}
//
