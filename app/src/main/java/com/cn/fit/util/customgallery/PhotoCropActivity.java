...
import com.cn.fit.util.BitmapUtils;
import com.cn.fit.util.CropImageView;
import com.cn.fit.util.DateUtils;
...
public class PhotoCropActivity extends PhotoBaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.fab_ok) {
            ...
            try {
                new File(AppDisk.PICTUREFOLDER, ".nomedia").createNewFile();
            } catch (IOException e) {
                e.printStackTrace();
            }
            ...
            try {
                File toFile = new File(AppDisk.PICTUREFOLDER, "IMG" + DateUtils.format(new Date(), "yyyyMMddHHmmss") + ".jpg");
