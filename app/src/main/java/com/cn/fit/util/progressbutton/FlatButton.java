package com.cn.fit.util.progressbutton;
...
public class FlatButton extends Button {
    ...
    private LayerDrawable createNormalDrawable(TypedArray attr) {
        ...
        int blueDark = getColor(R.color.blue_third);
        int colorPressed = attr.getColor(R.styleable.FlatButton_pb_colorPressed, blueDark);
        drawableTop.setColor(getResources().getColor(R.color.blue_second));
        ...
        int blueNormal = getColor(R.color.blue_second);
