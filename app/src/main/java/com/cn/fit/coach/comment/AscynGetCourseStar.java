 ...
 */
public class AscynGetCourseStar extends AsyncTask<Integer, Integer, BeanGetStar> {

    public AscynGetCourseStar() {
        super();
    }
    ...
    private String urls = "/my/app/classstar";
    private String pamrms = "classID";
    private long ids;

    private BeanGetStar bean;

    public AscynGetCourseStar(Context context, long ids) {
