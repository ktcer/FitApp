package com.cn.fit.weixin.pay;

public class Constants {

    public static final String APP_ID = "wx349b63ceddcb1d64";

    public static final String MCH_ID = "1266319501";

    public static final String API_KEY = "20e4eff76c2885c0e871de735d50198e";
